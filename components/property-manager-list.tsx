...
import { Trash2, Mail, Phone, Home, ExternalLink } from 'lucide-react'
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2 mt-4">
              <Link href={`/admin/manager/${manager.id}`}>
                <Button variant="outline" className="w-full border-white/30 hover:bg-white/10 hover:border-white/50 text-white">
